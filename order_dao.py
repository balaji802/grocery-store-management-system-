...
def get_order_details(connection, order_id):
    ...
    # Notice the fix here: products.products_id
    ...
    records = []
    for (order_id_db, quantity, total_price, product_name, price_per_unit) in cursor:
        records.append({
...
def get_all_orders(connection):
    ...
    # FIX: Explicitly selecting the 4 columns instead of using SELECT *
